...
#include "../Instructor Inteface/login_form.h"
...
QT_MOC_LITERAL(1, 11, 10), // "check_Cred"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 16) // "on_Login_clicked"

    },
    "Login_form\0check_Cred\0\0on_Login_clicked"
};
...
void Login_form::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Login_form::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Login_form::check_Cred)) {
                *result = 0;
                return;
            }
        }
